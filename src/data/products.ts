...
export const allProducts: Product[] = [
...
},
  {
    ...
    composition: ["3 breakfast sausage", "Œufs brouillés", "Baked Beans", "2 tranches de pain au levain", "Sauce à l'avocat", "1 jus frais au choix", "1 boisson chaude au choix"],
    options: [
      {
        id: "jus",
        label: "Jus frais",
