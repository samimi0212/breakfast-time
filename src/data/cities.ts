...
export const cities: City[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Vous pouvez composer votre commande librement sur notre carte en ligne et choisir vos produits à l'unité ou en menu.",
        a_en: "You can build your order freely from our online menu and choose products individually or as a set menu.",
      },
    ],
  ...
  },
  {
    ...
    intro_en:
      "Breakfast Time delivers your corporate and seminar breakfasts across the whole Sophia Antipolis technology park — fresh, delivered and set up, 7 days a week from 8am to 3pm.",
    quartiers: ["Les Lucioles", "Garbejaire", "Saint-Philippe", "Les Templiers", "Valbonne village", "Le parc d'activités"],
    context:
      "Première technopole d'Europe, Sophia Antipolis concentre des centaines d'entreprises à quelques minutes de notre local. Breakfast Time est idéalement placé pour livrer vos réunions matinales, accueils clients, onboarding et séminaires. Petits-déjeuners individuels ou plateaux à partager, livrés et installés à l'heure, pour démarrer la journée du bon pied.",
    context_en:
      "Europe's leading technology park, Sophia Antipolis is home to hundreds of companies just minutes from our kitchen. Breakfast Time is perfectly placed to cater your morning meetings, client welcomes, onboarding sessions and seminars. Individual breakfasts or sharing platters, delivered and set up on time, to start the day right.",
    useCases: [
      {
        title: "Petit-déjeuner d'équipe",
        title_en: "Team breakfast",
        text: "Le « Friday Breakfast » qui motive les équipes : viennoiseries, boissons chaudes et jus livrés au bureau.",
        text_en: "The 'Friday Breakfast' that motivates teams: pastries, hot drinks and juice delivered to the office.",
      },
      {
        title: "Réunion & accueil client",
        title_en: "Meetings & client welcome",
        text: "Impressionnez vos clients dès l'accueil avec un plateau soigné de viennoiseries et de café frais.",
        text_en: "Impress clients from the welcome with a refined platter of pastries and fresh coffee.",
      },
      {
        title: "Séminaire & événement",
        title_en: "Seminar & event",
        text: "Petit-déjeuner séminaire pour 5 à 60+ personnes, sur devis, livré et installé sur place.",
        text_en: "Seminar breakfast for 5 to 60+ people, on quote, delivered and set up on site.",
      },
    ],
    faq: [
      {
        q: "Livrez-vous les entreprises de Sophia Antipolis ?",
        q_en: "Do you deliver to companies in Sophia Antipolis?",
        a: "Oui, c'est l'une de nos spécialités. Nous livrons et installons les petits-déjeuners d'équipe, réunions et séminaires sur toute la technopole.",
        a_en: "Yes, it's one of our specialities. We deliver and set up team breakfasts, meetings and seminars across the whole park.",
      },
      {
        q: "Comment commander un petit-déjeuner d'entreprise ?",
        q_en: "How do I order a corporate breakfast?",
        a: "Pour les commandes groupées et événements professionnels, demandez un devis via notre page Événements ou contactez-nous directement.",
        a_en: "For group orders and professional events, request a quote via our Events page or contact us directly.",
      },
      {
        q: "Pouvez-vous livrer tôt le matin avant une réunion ?",
        q_en: "Can you deliver early before a meeting?",
        a: "Nous livrons à partir de 8h, 7j/7. Pour un créneau précis avant une réunion, indiquez-le lors de votre demande de devis.",
        a_en: "We deliver from 8am, 7 days a week. For a precise slot before a meeting, mention it in your quote request.",
      },
    ],
    metaTitle: "Petit-déjeuner entreprise Sophia Antipolis — Livraison & séminaire | Breakfast Time",
    metaTitle_en: "Corporate Breakfast Sophia Antipolis — Delivery & Seminars | Breakfast Time",
    metaDesc:
      "Livraison de petits-déjeuners d'entreprise et de séminaire à Sophia Antipolis. Plateaux livrés et installés, 7j/7 dès 8h. Devis pour groupes et événements.",
    metaDesc_en:
      "Corporate and seminar breakfast delivery in Sophia Antipolis. Platters delivered and set up, 7 days a week from 8am. Quotes for groups and events.",
  },
  {
    slug: "nice",
    name: "Nice",
