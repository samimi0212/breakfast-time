  ...
  <div style="max-width:580px;margin:0 auto;padding:32px 16px 48px;">
    ...
    <div style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
      ...
      <div style="padding:44px 40px 40px;">
        ...
        <p style="margin:0 0 32px;text-align:center;font-size:15px;color:#6b6b4a;line-height:1.7;">
          Le week-end approche — l'occasion parfaite pour un bon petit-déjeuner livré chez vous.
        </p>

        <div style="background:#f2ede4;border-radius:14px;padding:24px;text-align:center;margin-bottom:36px;">
          <p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:#9a9478;">Livraison offerte ce week-end</p>
          <p style="margin:0 0 10px;font-size:28px;font-weight:800;letter-spacing:5px;color:#1e1e06;">RETOUR</p>
          <p style="margin:0;font-size:13px;color:#9a9478;">Valable samedi et dimanche uniquement</p>
        </div>
    ...
    console.error("Reengagement email error:", error);
